...
namespace shortcutmaker
{
    ...
    public class Program
    {
        ...
        static int Main(string[] args)
        {
            ...
            String sCmd, sOriginPath, sShortCutDirectory, sShortCutWorkingDirectory, sShortCutName, sShortCutDescription, sShortCutIcon, sCommandToFile;
            bool bHelp = false;
            ...
            try
            {
                ...
                sCmd = sOriginPath = sShortCutDirectory = sShortCutWorkingDirectory = sShortCutName = sShortCutDescription = sShortCutIcon = sCommandToFile = "";
                ...
                else
                {
                    ...
                    if ("" != sCommandToFile)
                    {
                        System.IO.File.AppendAllText(sCommandToFile, sCmd + Environment.NewLine);
                    }
        ...
        private static int _createShortCutTo(String p_sOriginPath, String p_sShortCutDirectory, String p_sShortCutWorkingDirectory, String p_sShortCutName, String p_sShortCutDescription, String p_sShortCutIcon)
        {
            ...
            try
            {
                ...
                {
                    p_sShortCutDirectory = System.IO.Path.GetDirectoryName(p_sOriginPath) + "\\";
                }
                ...
                {
                    p_sShortCutName = System.IO.Path.GetFileNameWithoutExtension(p_sOriginPath) + ".lnk";
                }
